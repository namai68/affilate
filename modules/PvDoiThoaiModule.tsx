      ...
      <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm mb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-4 bg-red-50/30 p-6 rounded-2xl border border-red-100">
            <h3 className="text-xs font-black text-red-600 uppercase tracking-widest px-1">Nhân vật B (Khách mời)</h3>
            <div className="grid grid-cols-2 gap-3">
            ...
            <input list="pv-addr-b" value={state.charB.addressing} onChange={e => setState(p => ({ ...p, charB: { ...p.charB, addressing: e.target.value } }))} className="w-full p-3 bg-white border border-red-100 rounded-xl font-bold text-xs" placeholder="Xưng hô B" />
          ...
          <div className="space-y-4">
            ...
            <div onClick={() => bgInputRef.current?.click()} className="h-28 border-2 border-dashed border-orange-200 rounded-xl flex items-center justify-center bg-orange-50/30 cursor-pointer overflow-hidden relative group">
                {state.backgroundPreview ? <img src={state.backgroundPreview} className="h-full object-cover w-full" /> : <span className="text-[9px] font-bold text-orange-400 uppercase">Bối cảnh chung</span>}
            ...
            <textarea value={state.userContent} onChange={e => setState(p => ({ ...p, userContent: e.target.value }))} placeholder="Ý tưởng hội thoại..." className="w-full p-4 bg-slate-50 border border-slate-200 rounded-2xl h-24 text-xs font-bold focus:ring-2 focus:ring-orange-100 outline-none" />
            <div className="grid grid-cols-2 gap-2">
